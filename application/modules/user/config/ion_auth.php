...
// The number of milliseconds after which a forgot password request will expire. 
...
// "config" = use the settings defined here, 
// "form_validation" = use the settings defined in CI's form validation library
